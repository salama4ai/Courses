...
d3 = zeros(K,length(y)); d3 = a3-Y; d2 = (Theta2.')*d3; d2 = d2([2:end],:); d2 = d2.*sigmoidGradient(z2); 
Theta1_grad = (d2*G)./m;   Theta2_grad = (d3*a2.')./m;
Theta1_grad_reg = [(zeros(size(Theta1,1),1)),Theta1(:,[2:end])];  
